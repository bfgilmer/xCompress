...
public class ModBlocks {
    ...
    public static Block SNOW_1;

    @ObjectHolder("compressium:snow_2")
    public static Block SNOW_2;

    @ObjectHolder("compressium:snow_3")
    public static Block SNOW_3;

    @ObjectHolder("compressium:snow_4")
    public static Block SNOW_4;

    @ObjectHolder("compressium:snow_5")
    public static Block SNOW_5;

    @ObjectHolder("compressium:snow_6")
    public static Block SNOW_6;

    @ObjectHolder("compressium:snow_7")
    public static Block SNOW_7;

    @ObjectHolder("compressium:snow_8")
    public static Block SNOW_8;

    @ObjectHolder("compressium:snow_9")
    public static Block SNOW_9;




    @ObjectHolder("compressium:netherrack_1")
    public static Block NETHERRACK_1;

    @ObjectHolder("compressium:netherrack_2")
    public static Block NETHERRACK_2;

    @ObjectHolder("compressium:netherrack_3")
    public static Block NETHERRACK_3;

    @ObjectHolder("compressium:netherrack_4")
    public static Block NETHERRACK_4;

    @ObjectHolder("compressium:netherrack_5")
    public static Block NETHERRACK_5;

    @ObjectHolder("compressium:netherrack_6")
    public static Block NETHERRACK_6;

    @ObjectHolder("compressium:netherrack_7")
    public static Block NETHERRACK_7;

    @ObjectHolder("compressium:netherrack_8")
    public static Block NETHERRACK_8;

    @ObjectHolder("compressium:netherrack_9")
    public static Block NETHERRACK_9;


    // Clay
    @ObjectHolder("compressium:clay_1")
    public static Block CLAY_1;

    @ObjectHolder("compressium:clay_2")
    public static Block CLAY_2;

    @ObjectHolder("compressium:clay_3")
    public static Block CLAY_3;

    @ObjectHolder("compressium:clay_4")
    public static Block CLAY_4;

    @ObjectHolder("compressium:clay_5")
    public static Block CLAY_5;

    @ObjectHolder("compressium:clay_6")
    public static Block CLAY_6;

    @ObjectHolder("compressium:clay_7")
    public static Block CLAY_7;

    @ObjectHolder("compressium:clay_8")
    public static Block CLAY_8;
...
// Sand
    ...
    @ObjectHolder("compressium:sand_1")
    public static Block SAND_1;

    @ObjectHolder("compressium:sand_2")
    public static Block SAND_2;

    @ObjectHolder("compressium:sand_3")
    public static Block SAND_3;

    @ObjectHolder("compressium:sand_4")
    public static Block SAND_4;

    @ObjectHolder("compressium:sand_5")
    public static Block SAND_5;

    @ObjectHolder("compressium:sand_6")
    public static Block SAND_6;

    @ObjectHolder("compressium:sand_7")
    public static Block SAND_7;

    @ObjectHolder("compressium:sand_8")
    public static Block SAND_8;

    @ObjectHolder("compressium:sand_9")
    public static Block SAND_9;

// Gravel

    @ObjectHolder("compressium:gravel_1")
    public static Block GRAVEL_1;

    @ObjectHolder("compressium:gravel_2")
    public static Block GRAVEL_2;

    @ObjectHolder("compressium:gravel_3")
    public static Block GRAVEL_3;

    @ObjectHolder("compressium:gravel_4")
    public static Block GRAVEL_4;

    @ObjectHolder("compressium:gravel_5")
    public static Block GRAVEL_5;

    @ObjectHolder("compressium:gravel_6")
    public static Block GRAVEL_6;

    @ObjectHolder("compressium:gravel_7")
    public static Block GRAVEL_7;

    @ObjectHolder("compressium:gravel_8")
    public static Block GRAVEL_8;

    @ObjectHolder("compressium:gravel_9")
    public static Block GRAVEL_9;
