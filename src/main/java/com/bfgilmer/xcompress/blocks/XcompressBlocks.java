...
public class XcompressBlocks {
	...
	// Cobblestone
	public static final RegistryObject<BaseBlock> COBBLESTONE_1 = register("cobblestone_1",
			() -> new CobblestoneBlock(1));
	public static final RegistryObject<BaseBlock> COBBLESTONE_2 = register("cobblestone_2",
			() -> new CobblestoneBlock(2));
	public static final RegistryObject<BaseBlock> COBBLESTONE_3 = register("cobblestone_3",
			() -> new CobblestoneBlock(3));
	public static final RegistryObject<BaseBlock> COBBLESTONE_4 = register("cobblestone_4",
