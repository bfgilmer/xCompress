package com.bfgilmer.xcompress.client.model.inventory;
...
@OnlyIn(Dist.CLIENT)
public class XcompressItemStackRenderer<T extends TileEntity> extends ItemStackTileEntityRenderer {

  private final Supplier<T> te;

  public XcompressItemStackRenderer(Supplier<T> te) {
    this.te = te;
  }
